...
export const EVENT_LABELS: Record<DomainEventKey, string> = {
  ...
  "project.workflow_started": "Workflow iniciado",
  "project.phase_activated": "Fase ativada",
  "project.phase_completed": "Fase concluída",
  "project.workflow_task_status_changed": "Tarefa atualizada",
  "project.workflow_task_completed": "Tarefa concluída",
  "project.waiting_client": "Aguardando cliente",
