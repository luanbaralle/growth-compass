    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-24 pt-16 sm:px-8 sm:pt-24 lg:pb-32 lg:pt-28">
        <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <HeroVisual monthlySearches={hero.monthlySearches} city={city} />
        </div>
      </div>
    </section>
  );
...
function HeroVisual({ monthlySearches, city }: { monthlySearches: string; city?: string }) {
  const steps = [
    ...
    { icon: MessageSquare, label: "Contato", sub: "novo cliente" },
  ];
